...
def accuracy(y_hat, y):
    ...
    val = pd.Series(y_hat.reset_index(drop=True) ==
                    y.sort_index().reset_index(drop=True))
...
def bleu_score(candidate_txt='candidate.txt', reference_txt='reference.txt'):
    reference = open(reference_txt, 'r').readlines()
    candidate = open(candidate_txt, 'r').readlines()
